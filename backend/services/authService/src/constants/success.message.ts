export const SUCCESS_MESSAGES = {
  ...
  USER_OTP_RESEND_LIMIT_EXCEEDED:
    "Resend limit exceeded. Try again after some time.",
  USER_OTP_VERIFICATION_LIMIT_EXCEEDED:
    "Verification limit exceeded. Try again after some time.",
